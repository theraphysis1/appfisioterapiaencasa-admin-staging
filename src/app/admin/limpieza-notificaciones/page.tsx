...
import { useLimpiezaNotificaciones } from './hooks/useLimpiezaNotificaciones'

// Formatear fecha para mostrar en el preview
...
export default function LimpiezaNotificacionesPage() {
  const {
    activeTab,
    handleChangeTab,
    therapists,
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mt-2">
            Eliminar registros del historial de notificaciones push por terapeuta o por rango de fechas
          </p>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                  Los registros eliminados NO se pueden recuperar. Esto solo borra el historial de notificaciones, no afecta citas ni pacientes.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-md mb-6">
          <div className="flex border-b border-zinc-200 dark:border-zinc-700">
            <button
              onClick={() => handleChangeTab('terapeuta')}
            ...
            <button
              onClick={() => handleChangeTab('fechas')}
              className={`flex-1 px-6 py-4 text-sm font-medium transition-colors ${
                activeTab === 'fechas'
                  ? 'border-b-2 border-emerald-500 text-emerald-600 dark:text-emerald-400'
                  : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'
          ...
          <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleSelectTherapist(e.target.value)}
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
                  Se eliminarán TODOS los registros de notificaciones de este terapeuta (sin importar la fecha).
                </p>
              </div>
            )}
            ...
            {activeTab === 'fechas' && (
              <div className="space-y-4">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400">
                  Se eliminarán TODOS los registros de notificaciones de TODOS los terapeutas en este rango de fechas.
                </p>
              </div>
            )}
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <span className="block text-xs text-zinc-500 dark:text-zinc-400">
                          {reg.titulo} ({reg.tipo_evento})
                        </span>
                      </div>
                      <div className="flex items-center gap-4 text-zinc-600 dark:text-zinc-400">
                        <span>{formatDate(reg.fecha)}</span>
                        <span className={reg.estado === 'Enviada' ? 'text-green-600' : 'text-red-600'}>
                          {reg.estado}
                        </span>
                      </div>
                    </div>
